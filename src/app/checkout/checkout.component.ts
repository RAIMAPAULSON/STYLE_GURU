  ...
  private initConfig(): void {
    this.payPalConfig = {
      ...
      onClientAuthorization: (data) => {
        ...
        //step to perform after payment succesfully completed
        this.api.emptyCartAPI().subscribe((res: any) => {
          this.api.getCartCount()
          this.toaster.success("Payment Successfully Completed...Thankyou for purchasing with us!!!")
      ...
      onError: err => {
        ...
        this.toaster.warning("Transaction has been failed...Please try after sometime!!!")
      },
